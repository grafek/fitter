    ...
    >
      <div className="mb-4 flex items-center space-x-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="h-2 w-28 rounded-full bg-gray-200 dark:bg-gray-700"></div>
        </div>
      </div>
      ...
      <div className="mb-4 flex h-96 items-center justify-center rounded bg-gray-300 dark:bg-gray-700">
        <svg
